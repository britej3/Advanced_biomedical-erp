...
export default function Maintenance() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOpen(false);
      setFormData({ equipmentId: "", type: "preventive", description: "", scheduledDate: "", status: "scheduled", notes: "" });
      setEditingId(null);
      refetch();
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600 mt-1">Track preventive and corrective maintenance</p>
        </div>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Enter maintenance details below</DialogDescription>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>All maintenance schedules and history</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            <div className="space-y-2">
                ...
                <tbody>
                  {maintenance.map((item: any) => (
                    <tr key={item.id} className="border-b hover:bg-slate-50">
                      <td className="py-2 px-4 font-medium">{getEquipmentName(item.equipmentId)}</td>
                      ...
                      <td className="py-2 px-4">{new Date(item.scheduledDate).toLocaleDateString()}</td>
                      <td className="py-2 px-4">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-slate-600">No maintenance records found. Schedule your first maintenance.</p>
            </div>
          )}
        </CardContent>
      </Card>
