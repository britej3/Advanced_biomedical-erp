  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = {
        ...
        status: formData.status as "open" | "in_progress" | "completed" | "on_hold" | "cancelled",
      ...
      setOpen(false);
      setFormData({ title: "", description: "", priority: "medium", status: "open", dueDate: "", assignedTo: "", equipmentId: "" });
      setEditingId(null);
      refetch();
    } catch (error) {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-600 mt-1">Create and manage work orders for your team</p>
        </div>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Enter work order details below</DialogDescription>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700">Related Equipment</label>
                <select
        ...
        <CardContent>
          {isLoading ? (
                ...
                <tbody>
                  {workOrders.map((item: any) => (
                    <tr key={item.id} className="border-b hover:bg-slate-50">
                      ...
                      <td className="py-2 px-4">{getUserName(item.assignedTo)}</td>
                      <td className="py-2 px-4">{getEquipmentName(item.equipmentId)}</td>
                      <td className="py-2 px-4">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-slate-600">No work orders found. Create your first work order.</p>
            </div>
          )}
        </CardContent>
      </Card>
